...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\declaretheoremstyle[
    headfont=\bfseries\sffamily\color{haw}, bodyfont=\normalfont,
    mdframed={
        linewidth=2pt,
...
% Declare the theorem environments
\declaretheorem[style=hawbox, name=Hinweis]{Bericht}
\declaretheorem[style=thmgreenbox, name=Bericht]{Remark}
